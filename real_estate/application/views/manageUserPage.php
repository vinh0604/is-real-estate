...
<head>
	...
	$(document).ready(function(){
		...
		$('#form_view').dialog({ buttons : [
				{text: "Lưu tài khoản",click: function() { $('#account_frm').validationEngine('validate');} },
		    	{text: "Đóng",click: function() { $(this).dialog("close"); } }
			],
			autoOpen: false,
			modal: true,
...
<body>
	...
	<div id="form_view" style="display: none;">
		...
		<form action="#" method="post" id="account_frm">
			<table>
				<tr>
					<td>
					...
					<table border="0" cellspacing="0" cellpadding="0" id="account_table" class="display">
						...
						<tbody>
							<tr>
								...
								<td>vinh.bachsy</td>
								<td>Bạch Sỹ Đức Vinh</td>
								<td><a href="#">vinhbsd@abc.com</a></td>
								<td><a href="#" class="edit_btn"><img src="<?=base_url()?>images/edit.png" height="24" width="24" title="Chỉnh sửa tài khoản"/></a></td>
							</tr>
						</tbody>
					</table>
				</div>
